        ...
        try(CallableStatement stmt = conn.prepareCall(procDesc.toString())){
            ...
            for (int i = 0; i < n; i++) {
                if (paramObjs[i] == null)
                    ...
                    stmt.setObject(i + 2, DatetimeOpt.convertSqlTimestamp((java.util.Date) paramObjs[i]));
                else
        ...
        if (paramObjs != null) {
            for (int i = 0; i < paramObjs.length; i++) {
                if (paramObjs[i] == null)
                    ...
                    stmt.setObject(i + 1, DatetimeOpt.convertSqlTimestamp((java.util.Date) paramObjs[i]));
                else
        ...
        if (paramObjs != null) {
            for (int i = 0; i < paramObjs.size(); i++) {
                if (paramObjs.get(i) == null)
                    ...
                    stmt.setObject(i + 1, DatetimeOpt.convertSqlTimestamp((java.util.Date) paramObjs.get(i)));
                else
