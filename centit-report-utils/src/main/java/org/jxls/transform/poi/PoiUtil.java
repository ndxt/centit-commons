...
public class PoiUtil {
    ...
    public static void copySheetProperties(Sheet src, Sheet dest) {
        ...
        //增加拷贝页边距的方法
        dest.setMargin(PageMargin.TOP,src.getMargin(PageMargin.BOTTOM));
        dest.setMargin(PageMargin.LEFT,src.getMargin(PageMargin.BOTTOM));
        dest.setMargin(PageMargin.RIGHT,src.getMargin(PageMargin.BOTTOM));
