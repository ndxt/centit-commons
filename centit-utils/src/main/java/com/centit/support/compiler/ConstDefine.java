...
public abstract class ConstDefine {
    ...
    public static final int FUNC_STRLEN  = 156;
    public static final int FUNC_TIME_SPAN = 157;
    public static final int FUNC_ADD_TIME = 158;
    ...
    public static final int FUNC_GET_ATTR = 168;
    ...
    public static final int OP_OR = OP_LOGICOR;  //||
    public static final int OP_AND = OP_LOGICAND;  //&&
